...
public class ResourcePermissionCacheModel implements CacheModel<ResourcePermission>,
	...
	public ResourcePermission toEntityModel() {
		...
		resourcePermissionImpl.setViewPermission(viewPermission);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		viewPermission = objectInput.readBoolean();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeBoolean(viewPermission);
	}
