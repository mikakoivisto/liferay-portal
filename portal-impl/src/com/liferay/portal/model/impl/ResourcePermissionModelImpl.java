...
public class ResourcePermissionModelImpl extends BaseModelImpl<ResourcePermission>
	...
	public static final long VIEWPERMISSION_COLUMN_BITMASK = 64L;
	...
	public static ResourcePermission toModel(ResourcePermissionSoap soapModel) {
		...
		model.setViewPermission(soapModel.getViewPermission());
	...
	public void setViewPermission(boolean viewPermission) {
		_columnBitmask |= VIEWPERMISSION_COLUMN_BITMASK;

		if (!_setOriginalViewPermission) {
			_setOriginalViewPermission = true;

			_originalViewPermission = _viewPermission;
		}

		_viewPermission = viewPermission;
	}

	public boolean getOriginalViewPermission() {
		return _originalViewPermission;
	}
	...
	public Object clone() {
		...
		resourcePermissionImpl.setViewPermission(getViewPermission());
	...
	public void resetOriginalValues() {
		...
		resourcePermissionModelImpl._originalViewPermission = resourcePermissionModelImpl._viewPermission;

		resourcePermissionModelImpl._setOriginalViewPermission = false;
	...
	public CacheModel<ResourcePermission> toCacheModel() {
		...
		resourcePermissionCacheModel.viewPermission = getViewPermission();
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>viewPermission</column-name><column-value><![CDATA[");
		sb.append(getViewPermission());
		sb.append("]]></column-value></column>");
	...
	private boolean _originalViewPermission;
	private boolean _setOriginalViewPermission;
