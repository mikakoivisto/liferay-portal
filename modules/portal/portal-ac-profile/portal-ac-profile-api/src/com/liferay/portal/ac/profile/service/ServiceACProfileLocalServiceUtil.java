...
public class ServiceACProfileLocalServiceUtil {
	...
	*/
	...
	public static ServiceACProfileLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ServiceACProfileLocalService.class.getName());

			if (invokableLocalService instanceof ServiceACProfileLocalService) {
				_service = (ServiceACProfileLocalService)invokableLocalService;
			}
			else {
				_service = new ServiceACProfileLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ServiceACProfileLocalServiceUtil.class,
				"_service");
		}
	...
	private static ServiceACProfileLocalService _service;
}