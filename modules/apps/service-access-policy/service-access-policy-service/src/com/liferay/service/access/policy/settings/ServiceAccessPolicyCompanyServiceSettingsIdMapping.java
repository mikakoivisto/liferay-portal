 ...
 */
@Component
public class ServiceAccessPolicyCompanyServiceSettingsIdMapping
	implements SettingsIdMapping {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return ServiceAccessPolicyConfiguration.class;
	}

	@Override
	public String getSettingsId() {
		return ServiceAccessPolicyConstants.SERVICE_NAME;
	}
