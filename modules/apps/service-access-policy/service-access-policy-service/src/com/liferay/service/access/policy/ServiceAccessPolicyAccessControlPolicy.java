...
public class ServiceAccessPolicyAccessControlPolicy
	...
	public void onServiceRemoteAccess(
		...
		try {
			serviceAccessPolicyConfiguration = _settingsFactory.getSettings(
				ServiceAccessPolicyConfiguration.class,
				new CompanyServiceSettingsLocator(
					CompanyThreadLocal.getCompanyId(),
					ServiceAccessPolicyConstants.SERVICE_NAME));
		}
		...
		for (String name : serviceAccessPolicyNames) {
			try {
				...
				allowedServiceSignatures.addAll(
					serviceAccessPolicy.getAllowedServiceSignaturesList());
			}
