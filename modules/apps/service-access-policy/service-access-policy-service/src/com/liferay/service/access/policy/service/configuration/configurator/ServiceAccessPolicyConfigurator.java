...
package com.liferay.service.access.policy.service.configuration.configurator;
 ...
 */
@Component( immediate = true, service = ServiceAccessPolicyConfigurator.class)
public class ServiceAccessPolicyConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends ServiceAccessPolicyConfigurator> clazz = getClass();
