...
/**
 * Provides the local service interface for ServiceAccessPolicy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ServiceAccessPolicyLocalServiceUtil
...
public interface ServiceAccessPolicyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServiceAccessPolicyLocalServiceUtil} to access the service access policy local service. Add custom service methods to {@link com.liferay.service.access.policy.service.impl.ServiceAccessPolicyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
