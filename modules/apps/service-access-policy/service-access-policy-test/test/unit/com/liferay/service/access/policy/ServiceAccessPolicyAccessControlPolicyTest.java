 ...
 */
public class ServiceAccessPolicyAccessControlPolicyTest {

	@Before
	public void setUp() {
		_serviceAccessPolicyAccessControlPolicy =
			new ServiceAccessPolicyAccessControlPolicy();
	}

	@Test
	public void testMatches() {
		Assert.assertTrue(
			_serviceAccessPolicyAccessControlPolicy.matches(
	...
	private ServiceAccessPolicyAccessControlPolicy
		_serviceAccessPolicyAccessControlPolicy;
