...
public class SACPEntryLocalServiceWrapper implements SACPEntryLocalService,
	...
	*/
	...
	@Override
	public com.liferay.service.access.control.profile.model.SACPEntry delteSACPEntry(
		com.liferay.service.access.control.profile.model.SACPEntry sacpEntry)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _sacpEntryLocalService.delteSACPEntry(sacpEntry);
	}
	...
	*/
	...
	public int getCompanySACPEntryCount(long companyId) {
		return _sacpEntryLocalService.getCompanySACPEntryCount(companyId);
	}
