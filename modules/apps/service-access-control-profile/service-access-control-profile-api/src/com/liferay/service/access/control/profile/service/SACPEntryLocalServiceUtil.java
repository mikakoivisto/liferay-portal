...
public class SACPEntryLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.service.access.control.profile.model.SACPEntry delteSACPEntry(
		com.liferay.service.access.control.profile.model.SACPEntry sacpEntry)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().delteSACPEntry(sacpEntry);
	}
	...
	*/
	...
	public static int getCompanySACPEntryCount(long companyId) {
		return getService().getCompanySACPEntryCount(companyId);
	}
