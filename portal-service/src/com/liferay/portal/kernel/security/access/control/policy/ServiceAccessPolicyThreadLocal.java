...
package com.liferay.portal.kernel.security.access.control.policy;
...
public class ServiceAccessPolicyThreadLocal {
	...
	public static void addActiveServiceAccessPolicyName(String policyName) {
		...
		activeServiceAccessPolicyNames.add(policyName);
	}
